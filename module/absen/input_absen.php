            <div class="row">
                <div class="col-lg-12">
					<h3 class="page-header"><strong>Input Data Presensi</h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
?>
                                            <label class="radio-inline">
                                                <input type="radio" name="<?php echo $rs['ids'] ?>" value="A"  >Alfa
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="<?php echo $rs['ids'] ?>" value="I">Ijin
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="<?php echo $rs['ids'] ?>" value="S">Sakit
                                            </label>

                                            <label class="radio-inline">
                                                <input type="radio" name="<?php echo $rs['ids'] ?>" value="H" >Hadir
                                            </label>
...
?>
                                            <label class="radio-inline">
                                                <input type="radio" name="<?php echo $rs['ids'] ?>" value="A" checked >Alfa
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="<?php echo $rs['ids'] ?>" value="I">Ijin
                                            </label>
...
?>
                                        ...
                                        <button type="submit" class="btn btn-success">Simpan Data Presensi</button>
