...
?>                                        <tr class="odd gradeX">
                                        ...
                                        <td class="text-center"><a href="./././media.php?module=absen&idj=<?php echo $rs['idj'] ?>"><button type="button" class="btn btn-info">Mulai Presensi</button></a>
                                          <a href="./././media.php?module=rekap_g&idj=<?php echo $rs['idj'] ?>"><button type="button" class="btn btn-warning">Rekap Presensi</button></a>
                                        </td>
                                        </tr>
<?php
$no++;}
