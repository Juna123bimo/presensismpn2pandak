 	...
 	<tr>
 		...
 		<td>
 			<center>
 				...
 				<h1>
 					Presensi Siswa SISWA <br>
 					<small> SMP Negeri 2 Pandak</small>
 				</h1>
 				<hr>
 				<em>
 					Glagahan, Caturharjo, Pandak, Koro Wejang, Caturharjo, Kec. Pandak<br> Bantul, Daerah Istimewa Yogyakarta, Kode Pos (55761) <br>
 				<b>Email : smpduapandak@yahoo.com Telp.08999404050</b> 
 				</em>
 		...
 		<td>
 			...
 			<table width="100%">
  <tr>
    <td colspan="2"><b style="padding: 2px;">
  ...
  <tr bgcolor="<?=$warna; ?>">
    ...
    <td align="center"><?=$ds['jk'];?></td>
		...
		<td align="center" bgcolor="white">
			...
			INNER JOIN tb_semester ON tb_mengajar.id_semester=tb_semester.id_semester
			INNER JOIN tb_thajaran ON tb_mengajar.id_thajaran=tb_thajaran.id_thajaran
			WHERE _logabsensi.pertemuan_ke='$i' AND _logabsensi.id_siswa='$ds[id_siswa]' AND _logabsensi.id_mengajar='
			$_GET[pelajaran]' AND tb_mengajar.id_mkelas='$_GET[kelas]'  AND tb_thajaran.status=1 AND tb_semester.
			status=1 GROUP BY pertemuan_ke ");
			foreach ($ket as $h)
